...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        String model = "Model1";
        int series = 1;
        User user = userService.findUserByCarModelAndSeries(model, series);
        System.out.printf("User with car model '%s' and series '%d': %s %s %n", model, series, user.getFirstName(), user.getLastName());
